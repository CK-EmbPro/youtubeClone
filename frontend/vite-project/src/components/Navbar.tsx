    ...
    return (
        <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
            ...
            <div className="flex gap-5 items-center text-xl">
                ...
                <img src="https://media.istockphoto.com/id/912299634/photo/computer-crime-concept.jpg?s=612x612&w=0&k=20&c=JOYSw69V4tr2hvnAt3HsOEbyXAoSXYulHrh8ifqqJXk=" alt="" className='rounded-full h-9 w-9' />
            </div>
        </div>
    )
}
